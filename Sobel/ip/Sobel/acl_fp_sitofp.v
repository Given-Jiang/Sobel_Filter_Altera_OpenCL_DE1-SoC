...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
module  acl_fp_sitofp_altbarrel_shift_qsf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //acl_fp_sitofp_altbarrel_shift_qsf
...
module  acl_fp_sitofp_altpriority_encoder_3e8
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //acl_fp_sitofp_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_sitofp_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	acl_fp_sitofp_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //acl_fp_sitofp_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_sitofp_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	acl_fp_sitofp_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //acl_fp_sitofp_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_sitofp_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	acl_fp_sitofp_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_sitofp_altpriority_encoder_rf8
...
module  acl_fp_sitofp_altpriority_encoder_3v7
	...
	assign
		q = {data[1]};
endmodule //acl_fp_sitofp_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
...
endmodule //acl_fp_sitofp_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
...
endmodule //acl_fp_sitofp_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	acl_fp_sitofp_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	acl_fp_sitofp_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_sitofp_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	acl_fp_sitofp_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	acl_fp_sitofp_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //acl_fp_sitofp_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 247 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_altfp_convert_uin
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	acl_fp_sitofp_altbarrel_shift_qsf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	acl_fp_sitofp_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //acl_fp_sitofp_altfp_convert_uin
//VALID FILE
...
module acl_fp_sitofp (
	...
	acl_fp_sitofp_altfp_convert_uin	acl_fp_sitofp_altfp_convert_uin_component (
				.clk_en (enable),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp.cmp TRUE TRUE
