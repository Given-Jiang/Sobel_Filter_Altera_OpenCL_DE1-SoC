//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix V" EXCEPTION_HANDLING="NO" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
module  acl_fp_mul_ll_s5_altfp_mult_u9o
	( 
	clk_en,
	clock,
	dataa,
...
endmodule //acl_fp_mul_ll_s5_altfp_mult_u9o
//VALID FILE
...
module acl_fp_mul_ll_s5 (
	...
	acl_fp_mul_ll_s5_altfp_mult_u9o	acl_fp_mul_ll_s5_altfp_mult_u9o_component (
				.clk_en (enable),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_ll_s5.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_ll_s5.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_ll_s5.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_ll_s5_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_ll_s5_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_ll_s5.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_ll_s5.cmp TRUE TRUE
