...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix IV" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock dataa datab result
...
module  acl_fp_add_double_altbarrel_shift_32e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //acl_fp_add_double_altbarrel_shift_32e
...
module  acl_fp_add_double_altbarrel_shift_oib
	...
	assign
		...
		sel_w = {distance[5:0]},
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //acl_fp_add_double_altbarrel_shift_oib
...
module  acl_fp_add_double_altpriority_encoder_3e8
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //acl_fp_add_double_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	acl_fp_add_double_altpriority_encoder_3e8   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //acl_fp_add_double_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	acl_fp_add_double_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //acl_fp_add_double_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_be8   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	acl_fp_add_double_altpriority_encoder_be8   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_add_double_altpriority_encoder_rf8
...
module  acl_fp_add_double_altpriority_encoder_3v7
	...
	assign
		q = {data[1]};
endmodule //acl_fp_add_double_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
...
endmodule //acl_fp_add_double_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
...
endmodule //acl_fp_add_double_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	acl_fp_add_double_altpriority_encoder_bv7   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	acl_fp_add_double_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_add_double_altpriority_encoder_r08

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_q08
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	acl_fp_add_double_altpriority_encoder_rf8   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	acl_fp_add_double_altpriority_encoder_r08   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //acl_fp_add_double_altpriority_encoder_q08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_qf8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_rf8   altpriority_encoder23
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	acl_fp_add_double_altpriority_encoder_rf8   altpriority_encoder24
	( 
	.data(data[31:16]),
...
endmodule //acl_fp_add_double_altpriority_encoder_qf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_0c6
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	acl_fp_add_double_altpriority_encoder_q08   altpriority_encoder7
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder7_q));
	acl_fp_add_double_altpriority_encoder_qf8   altpriority_encoder8
	( 
	.data(data[63:32]),
...
endmodule //acl_fp_add_double_altpriority_encoder_0c6
...
module  acl_fp_add_double_altpriority_encoder_nh8
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //acl_fp_add_double_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_nh8   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	acl_fp_add_double_altpriority_encoder_nh8   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //acl_fp_add_double_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	acl_fp_add_double_altpriority_encoder_qh8   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //acl_fp_add_double_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_vh8   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	acl_fp_add_double_altpriority_encoder_vh8   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_add_double_altpriority_encoder_fj8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_ej8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_add_double_altpriority_encoder_fj8   altpriority_encoder27
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	acl_fp_add_double_altpriority_encoder_fj8   altpriority_encoder28
	( 
	.data(data[31:16]),
...
endmodule //acl_fp_add_double_altpriority_encoder_ej8
...
module  acl_fp_add_double_altpriority_encoder_n28
	...
	assign
		q = {(~ data[0])};
endmodule //acl_fp_add_double_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
...
endmodule //acl_fp_add_double_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
...
endmodule //acl_fp_add_double_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	acl_fp_add_double_altpriority_encoder_vh8   altpriority_encoder37
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder37_q),
	.zero(wire_altpriority_encoder37_zero));
	acl_fp_add_double_altpriority_encoder_v28   altpriority_encoder38
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_add_double_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_e48
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	acl_fp_add_double_altpriority_encoder_fj8   altpriority_encoder35
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder35_q),
	.zero(wire_altpriority_encoder35_zero));
	acl_fp_add_double_altpriority_encoder_f48   altpriority_encoder36
	( 
	.data(data[31:16]),
...
endmodule //acl_fp_add_double_altpriority_encoder_e48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altpriority_encoder_k48
	( 
	data,
	q) ;
	input   [63:0]  data;
	...
	acl_fp_add_double_altpriority_encoder_ej8   altpriority_encoder25
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	acl_fp_add_double_altpriority_encoder_e48   altpriority_encoder26
	( 
	.data(data[63:32]),
...
endmodule //acl_fp_add_double_altpriority_encoder_k48

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 504 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_add_double_altfp_add_sub_qnj
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	acl_fp_add_double_altbarrel_shift_32e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	acl_fp_add_double_altbarrel_shift_oib   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	acl_fp_add_double_altpriority_encoder_0c6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[54:1], 1'b1, {9{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	acl_fp_add_double_altpriority_encoder_k48   trailing_zeros_cnt
	( 
...
endmodule //acl_fp_add_double_altfp_add_sub_qnj
//VALID FILE
...
module acl_fp_add_double (
	...
	acl_fp_add_double_altfp_add_sub_qnj	acl_fp_add_double_altfp_add_sub_qnj_component (
				.clk_en (enable),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_add_double.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_add_double.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_add_double.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_add_double.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_add_double_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_add_double_bb.v FALSE
