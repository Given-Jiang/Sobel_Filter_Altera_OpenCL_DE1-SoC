...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" OPERATION="FLOAT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clk_en clock dataa result
...
module  acl_fp_fpext_altfp_convert_qqn
	( 
	clk_en,
	clock,
	dataa,
...
endmodule //acl_fp_fpext_altfp_convert_qqn
//VALID FILE
...
module acl_fp_fpext (
	...
	acl_fp_fpext_altfp_convert_qqn	acl_fp_fpext_altfp_convert_qqn_component (
				.clk_en (enable),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_fpext.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_fpext.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_fpext.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_fpext_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_fpext_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_fpext.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_fpext.cmp TRUE TRUE
