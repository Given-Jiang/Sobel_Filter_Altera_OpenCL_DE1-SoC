...
// ============================================================
// File Name: acl_fp_sitofp_double.v
// Megafunction Name(s):
// 			ALTFP_CONVERT
//
...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=32 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  acl_fp_sitofp_double_altbarrel_shift_qsf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //acl_fp_sitofp_double_altbarrel_shift_qsf
...
module  acl_fp_sitofp_double_altpriority_encoder_3v7
	...
	assign
		q = {data[1]};
endmodule //acl_fp_sitofp_double_altpriority_encoder_3v7
...
module  acl_fp_sitofp_double_altpriority_encoder_3e8
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //acl_fp_sitofp_double_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	acl_fp_sitofp_double_altpriority_encoder_3v7   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q));
	acl_fp_sitofp_double_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //acl_fp_sitofp_double_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_sitofp_double_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	acl_fp_sitofp_double_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //acl_fp_sitofp_double_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
...
endmodule //acl_fp_sitofp_double_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_sitofp_double_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	acl_fp_sitofp_double_altpriority_encoder_6e8   altpriority_encoder17
	( 
	.data(data[7:4]),
...
endmodule //acl_fp_sitofp_double_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	acl_fp_sitofp_double_altpriority_encoder_bv7   altpriority_encoder8
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder8_q));
	acl_fp_sitofp_double_altpriority_encoder_be8   altpriority_encoder9
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_sitofp_double_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	acl_fp_sitofp_double_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	acl_fp_sitofp_double_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[15:8]),
...
endmodule //acl_fp_sitofp_double_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
...
endmodule //acl_fp_sitofp_double_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 290 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_sitofp_double_altfp_convert_fkn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	acl_fp_sitofp_double_altbarrel_shift_qsf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	acl_fp_sitofp_double_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //acl_fp_sitofp_double_altfp_convert_fkn
//VALID FILE
...
module acl_fp_sitofp_double (
	...
	acl_fp_sitofp_double_altfp_convert_fkn	acl_fp_sitofp_double_altfp_convert_fkn_component (
				.clk_en (enable),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_double.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_double.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_double.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_double_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_double_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_double.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_sitofp_double.cmp FALSE TRUE
