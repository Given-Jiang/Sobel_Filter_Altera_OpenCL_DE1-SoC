...
# Board skews
set board(abs_max_CK_delay) 0.419282
set board(abs_max_DQS_delay) 0.341732
set board(minCK_DQS_skew) -0.04854
set board(maxCK_DQS_skew) 0.202374
set board(tpd_inter_DIMM) 0.0
set board(intra_DQS_group_skew) 0.01
set board(inter_DQS_group_skew) 0.111445
set board(DQ_DQS_skew) 0.05
set board(intra_addr_ctrl_skew) 0.156188
