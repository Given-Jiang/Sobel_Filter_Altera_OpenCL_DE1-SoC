...
//altfp_exp CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" PIPELINE=17 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock data result
...
module  acl_fp_exp_altfp_exp_s7d
	( 
	clk_en,
	clock,
	data,
...
endmodule //acl_fp_exp_altfp_exp_s7d
//VALID FILE
...
module acl_fp_exp (
	...
	acl_fp_exp_altfp_exp_s7d	acl_fp_exp_altfp_exp_s7d_component (
				.clk_en (enable),
				.clock (clock),
				.data (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_exp.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_exp.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_exp.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_exp_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_exp_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_exp.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_exp.cmp FALSE TRUE
