...
// ============================================================
// File Name: acl_fp_mul_fast_double.v
// Megafunction Name(s):
// 			ALTFP_MULT
//
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   exp_result_ff <= ((inf_num & {11{((exp_is_inf | input_is_infinity_ff4) | input_is_nan_ff4)}}) | ((exp_adj_p2[10:0] & {11{(~ exp_is_zero)}}) & {11{input_not_zero_ff4}}));
	// synopsys translate_off
	initial
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   man_result_ff <= {((((((delay_round[51] & input_not_zero_ff4) & (~ input_is_infinity_ff4)) & (~ exp_is_inf)) & (~ exp_is_zero)) | (input_is_infinity_ff4 & (~ input_not_zero_ff4))) | input_is_nan_ff4), (((((delay_round[50:0] & {51{input_not_zero_ff4}}) & {51{(~ input_is_infinity_ff4)}}) & {51{(~ exp_is_inf)}}) & {51{(~ exp_is_zero)}}) & {51{(~ input_is_nan_ff4)}})};
	// synopsys translate_off
	initial
	...
	.datab({{53{1'b0}}, man_round_carry_p0}),
	.overflow(),
	...
	assign
		...
		result = {sign_node_ff9[0:0], exp_result_ff[10:0], man_result_ff[51:0]},
...
endmodule //acl_fp_mul_fast_double_altfp_mult_ufo
//VALID FILE
...
module acl_fp_mul_fast_double (
	...
	acl_fp_mul_fast_double_altfp_mult_ufo	acl_fp_mul_fast_double_altfp_mult_ufo_component (
				.clk_en (enable),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_fast_double.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_fast_double.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_fast_double.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_fast_double_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_fast_double_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_fast_double.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_mul_fast_double.cmp FALSE TRUE
