...
//altfp_compare CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" PIPELINE=3 WIDTH_EXP=11 WIDTH_MAN=52 aeb agb ageb alb aleb aneb clk_en clock dataa datab unordered
//VERSION_BEGIN 11.0 cbx_altfp_compare 2011:04:27:21:07:19:SJ cbx_cycloneii 2011:04:27:21:07:19:SJ cbx_lpm_add_sub 2011:04:27:21:07:19:SJ cbx_lpm_compare 2011:04:27:21:07:19:SJ cbx_mgl 2011:04:27:21:11:03:SJ cbx_stratix 2011:04:27:21:07:19:SJ cbx_stratixii 2011:04:27:21:07:19:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463


//synthesis_resources = lpm_compare 8 reg 31 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  acl_fp_cmp_double_altfp_compare_ine
	( 
	aeb,
	agb,
	ageb,
...
`endif
	...
	reg	[4:0]	man_a_not_zero_w_dffe1;
	reg	[4:0]	man_b_not_zero_w_dffe1;
	reg	out_aeb_w_dffe3;
	reg	out_agb_w_dffe3;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) man_a_not_zero_w_dffe1 <= 5'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) man_b_not_zero_w_dffe1 <= 5'b0;
...
endmodule //acl_fp_cmp_double_altfp_compare_ine
//VALID FILE
...
module acl_fp_cmp_double (
  ...
  parameter UNORDERED_MODE = 0;
	...
	acl_fp_cmp_double_altfp_compare_ine	acl_fp_cmp_double_altfp_compare_ine_component (
				.clk_en (enable),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_cmp_double.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_cmp_double.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_cmp_double.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_cmp_double.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_cmp_double_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL acl_fp_cmp_double_bb.v TRUE
